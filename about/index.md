...
| **Dedicated tools support** provided in [SAP Business Application Studio](../tools/ide#bastudio) or [Visual Studio Code](../tools/ide#vscode). | CAP doesn't depend on those tools. Everything in CAP can be done using the [`@sap/cds-dk`](../get-started/jumpstart) CLI and any editor or IDE of your choice. |
