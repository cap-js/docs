...
You can add your validation logic before the operation handler for either CRUD or draft specific events. See [Node.js > Fiori Support > Handlers Registration](../node.js/fiori#draftevents) for more details about handler registration.
