 ...
 * On *Cloud Foundry* you can provide this Java option [`-XX:+UseContainerCpuShares`](https://bugs.openjdk.org/browse/JDK-8281571) or use the Java Build pack >= 1.64.1 containing [this change](https://github.wdf.sap.corp/xs2-java/xs-java-buildpack/pull/1533/files).
