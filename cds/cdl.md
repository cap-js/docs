...
As indicated by the syntax coloring, `Association`, even though a keyword, can be seen as a type name, similar to `String`, `Books`, or `Authors`.  This highlights the fact that `author` is an association type.
