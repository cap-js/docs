...
The database services are validated against the maintained versions of SAP HANA Cloud. It's not guaranteed that outdated versions are fully functional with the latest database services.
