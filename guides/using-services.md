...
The `useCache` option controls whether the SAP Cloud SDK caches the destination. In Node.js, the destination caching is enabled by default and `useCache` is set to `true`.
