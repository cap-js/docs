...
The simple values of deserialized JSON payload may be of type: `String`, `Boolean`, `Integer`, `BigDecimal`.
...
The complex structures and types are represented as `Map`, Collections as `List`.
