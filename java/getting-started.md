...
2. Install a Java VM. At least, Java 17 is required, but it's suggested to use Java 21. For example, [download](https://github.com/SAP/SapMachine/releases/latest) and [install](https://github.com/SAP/SapMachine/wiki/Installation) SapMachine 17.
