...
::: warning
This migration guide is published as a preview. It may be subject to change before the release of CAP Java 2.0.
:::
...
make sure that all [minimum library versions](./development/#dependencies-version-2) required for Spring Boot 3 are configured.
