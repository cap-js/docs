...
Upsert can operate on deep [document structures](./data#nested-structures-and-associations) modeled via [compositions](../guides/domain-modeling#_5_-add-compositions), such as an `Order` with many `OrderItems`.
