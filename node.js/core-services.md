...
> Please note that this API is not yet implemented by any common `cds.Service` subclass (that is, `cds.DatabaseService`). Hence, the full result set currently is materialized in memory.
